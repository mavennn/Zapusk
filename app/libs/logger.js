...
global.logger = new function(){
	...
	this.write = function(name, data = ''){
		if(this.writeStreams[name] == undefined)
...
global.log = new Proxy(logger, {
    get(target, propKey, receiver) {
        if(logger[propKey] != undefined )
        	return logger[propKey];
        return function(...ags){
