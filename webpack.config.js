...
var front = {
	entry:{
		main: [ __dirname + '/src/js/main.js', 'webpack-hot-middleware/client?path=/__webpack_hmr&timeout=20000'],
	},
	output: {
...
var admin = {
	entry:{
		main: [ __dirname + '/src/admin/main.js', 'webpack-hot-middleware/client?path=/__webpack_hmr&timeout=20000'],
