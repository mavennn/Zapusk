...
(function($) {
  ...
  var defaults = {
    ...
    setExtraData: function(id){return {};},
    onComplete: function(){},
  ...
  DmUploader.prototype.processQueue = function()
  {
    ...
    widget.settings.extraData =  widget.settings.setExtraData.call(widget.element, widget.queuePos);
	...
	if(widget.settings.usePreload){
		$(widget.settings.preloadElement).show();
		widget.settings.countStart++;
	}
    ...
    $.ajax({
      ...
      complete: function(xhr, textStatus){
        ...
        if(widget.settings.usePreload){
			widget.settings.countStart--;
			if(widget.settings.countStart<=0)
				$(widget.settings.preloadElement).hide();
		}
