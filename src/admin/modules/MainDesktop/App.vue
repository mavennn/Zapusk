...
<script>
	...
	export default {
		...
		created(){
			...
			App.Router.Emitter.on('users', data => {this.page = 'users'; data.next()} )
			App.Router.Emitter.on('schedule', data => {this.page = 'schedule'; data.next()} )
			App.Router.Emitter.on('meetimes', data => {this.page = 'meetimes'; data.next()} )
			App.Router.Emitter.on('statistic', data => {this.page = 'statistic'; data.next()} )
		},
		methods:{
