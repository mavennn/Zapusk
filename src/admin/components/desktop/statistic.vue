            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr v-for="sp in speakers">
                  <td>
                    <a @click.prevent="openDetail(sp._id)"
                      >{{ sp.name }} {{ sp.sname }}</a
                    >
                  </td>
                  <td>
            ...
            <table class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th>Роль</th>
                  <th>
                    Какие главные проблемы в Вашей организации/стране в развитии
                    навыков?
                  </th>
                  <th>
                    Какие перспективы/цели/возможности Вы видите для Вашей
                    организации/страны?
                  </th>
              ...
              <tbody>
                <tr v-for="us in users">
                  ...
                  <th>
                    <span v-if="us.country">{{ tags[us.country].name }}</span>
                  </th>
                  <th>{{ us.city }}</th>
                  <th>{{ us.email }}</th>
                  <th>{{ us.phone }}</th>
                  <th>
                    <span v-if="us.organization">{{
                      us.organization.name
                    }}</span>
                  </th>
                  <th>
                    <span v-if="us.organization">{{
                      us.organization.position
                    }}</span>
                  </th>
                  <th>
                    <span v-if="us.organization"
                      ><span v-if="us.organization.role">{{
                        tags[us.organization.role].name
                      }}</span></span
                    >
                  </th>
                  <th>
                    <span v-if="us.organization">{{
                      us.organization.problems
                    }}</span>
                  </th>
                  <th>
                    <span v-if="us.organization">{{
                      us.organization.perspectives
                    }}</span>
                  </th>
                  <th>
                    <span v-if="us.organization">{{
                      us.organization.barriers
                    }}</span>
                  </th>
                  <th>
                    <span v-for="wsr in us.wsrProducts" v-if="us.wsrProducts">{{
                      tags[wsr].name + ", "
                    }}</span>
                  </th>
                  <th>
                    <span
                      v-if="us.partnership"
                      v-for="wsr in us.partnership.country"
                      >{{ tags[wsr].name + ", " }}</span
                    >
                  </th>
                  <th>
                    <span
                      v-if="us.partnership"
                      v-for="wsr in us.partnership.partnershipMode"
                      >{{ tags[wsr].name + ", " }}</span
                    >
                  </th>
                  <th>
                    <span
                      v-if="us.partnership"
                      v-for="wsr in us.partnership.industry"
                      >{{ tags[wsr].name + ", " }}</span
                    >
                  </th>
                  <th>
                    <span
                      v-if="us.partnership"
                      v-for="wsr in us.partnership.bestPractice"
                      >{{ tags[wsr].name + ", " }}</span
                    >
                  </th>
                  <th>
                    <span
                      v-if="us.partnership.role"
                      v-for="wsr in us.partnership.role"
                      >{{ tags[wsr].name + ", " }}</span
                    >
                  </th>
                </tr>
              ...
              <tbody>
                <tr v-for="us in speakerss">
                  ...
                  <th>
                    <span v-if="us.organization"
                      ><span v-if="us.organization.role"
                        ><span v-if="tags[us.organization.role]">{{
                          tags[us.organization.role].name
                        }}</span></span
                      ></span
                    >
...
export default {
  ...
  methods: {
    getStatic() {
      Request.postJson("/api/admin/static/get", {})
        .then(data => {
