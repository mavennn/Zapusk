...
export default {
  ...
  created() {
    App.Router.Emitter.on("main", data => {
      this.page = "main";
      data.next();
    });
    App.Router.Emitter.on("agenda", data => {
      this.page = "agenda";
      data.next();
    });
    ...
    App.Router.Emitter.on("schedulled", data => {
      this.page = "schedulled";
      data.next();
    });
    App.Router.Emitter.on("sign", data => {
      this.page = "sign";
      data.next();
    });
    App.Router.Emitter.on("meetings", data => {
      this.page = "meetings";
      data.next();
    });
    App.Router.Emitter.on("hall", data => {
      this.page = "hall";
      data.next();
    });
    App.Router.Emitter.on("adminagenda", data => {
      this.page = "adminagenda";
      data.next();
    });
  },
  methods: {},
