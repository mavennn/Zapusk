          ...
          <div class="smdcb-events">
            ...
            >
              ...
              <div class="smdcbei-person">
                <div class="smdcbeip-name">
                  {{ ev.speaker.name }} {{ ev.speaker.sname }}
                </div>
                <div class="smdcbeip-company" v-if="ev.speaker.organization">
                  &nbsp;| {{ ev.speaker.organization }}
                </div>
              </div>
            </div>
          </div>
