        ...
        <div class="sm-body">
            <div class="smb-current">
				...
				<div class="smbc-content">
					<div class="smbcc-row" v-for="(sp, key) in speakers" v-bind:key="'sp'+key">
			...
			<div class="smb-next">
				<div class="smbn-head">
					...
					<div class="smbnh-time">
						<countdown :time="10 * 60 * 1000">
							<template slot-scope="props">{{ props.minutes }} MINUTES</template>
						</countdown>
					</div>
				</div>
				<div class="smbn-row" v-for="(sp, key) in speakers" v-bind:key="'spn'+key">{{getName(getNext(sp.users))}}</div>
			</div>
			<div class="smb-next">
				<div class="smbn-head">
				...
				<div class="smbn-row" v-for="(sp, key) in speakers" v-bind:key="'span'+key">{{getName(getAfterNext(sp.users))}}</div>
			</div>
        </div>
	</div>
