	...
	<div class="skittles-profile" v-if="load">
            ...
            <div class="spb-content">
                <div class="spbc-row">
                    ...
                    <div class="spbcr-desc">
                        ...
                        <div class="spbcrdr-btm-l">{{lang == 'en'?'Not visible in public profile':'Не виден остальным'}}</div>
                        <div class="spbcrd-row">
                            <div class="spbcrdr-label">{{lang == 'en'?'Phone':'Телефон'}}:</div>
		...
		<div class="sp-block">
            ...
            <div class="spb-content">
                ...
                <div class="spbc-wr">
                    <div class="spbcw-label">{{lang == 'en'?'What main issues/problems do you have in your country/organization in skills development?':
                ...
                <div class="spbc-wr">
                    <div class="spbcw-label">{{lang == 'en'?'What perspectives/vision/goals/possibilities do you see for your country/organization?':
                        'Какие перспективы/цели/возможности Вы видите для Вашей организации/страны?'}}:</div>
                    <div class="spbcw-val">{{user.organization.perspectives || '-'}}</div>
                </div>
                <div class="spbc-wr">
                    <div class="spbcw-label">{{lang == 'en'?'What main obstacles/barriers do you see on your way to your vision/goals?':
		...
		<div class="sp-block" v-if="user.presentation">
            ...
            <div class="spb-content">
                <div class="spbc-block">
                    ...
                    <div class="spbc-button"><a :href="presentation.link" target="_blank">Tap to open pitchdeck</a></div>
                </div>
            </div>
        </div>
		<div class="sp-block">
